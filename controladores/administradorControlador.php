           ...
           $foto="Female3Avatarr.png";
            ...
            if($password1!=$password2){
                $alerta=[
                    ...
                    "Texto"=>"Las contraseñas que ingresaste no coinciden, por favor intente nuevamente",
                    "Tipo"=> "error"
                ];
            }else{
                ...
                if($consulta1->rowCount()>=1){
                    $alerta=[
                        "Alerta"=>"simple",
                        "Titulo"=>"Ocurrio un error inesperado",
                        "Texto"=>"El numero de Documento que acabas de ingresar ya se encuentra registrado en el sistema",
                        "Tipo"=> "error"
                    ];
                }else{
                   if($email!=""){
                        ...
                        if($guardarCuenta->rowCount()>=1){
                            ...
                            if($guardarAdmin->rowCount()>=1){
                                $alerta=[
                                    ...
                                    "Texto"=>"El Administrador se creo satisfactoriamente",
                                    "Tipo"=>"success"
                                ];
                            }else{
